...
typedef void    (*text_add_static_string_func)          (uint32_t, float, float, const wchar_t*);
typedef void    (*text_add_static_center_string_func)   (uint32_t, float, float, const wchar_t*);
